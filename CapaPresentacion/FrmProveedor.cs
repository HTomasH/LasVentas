...
{
    public partial class FrmProveedor : Form     // Es una PARTIAL CLASS  curso:  Se dividen pero al compilar es una sola !!!
    {
        ...
        public FrmProveedor()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtNombre, "Indique el Nombre del Proveedor");
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.txtIdProveedor.ReadOnly = true; // !valor;  //Es un valor Identity  lo 'capo del todo'
            this.txtIdProveedor.Enabled = false; // !valor;  //Es un valor Identity  lo 'capo del todo'
        ...
        //-->Método para ocultar columnas en el Grid 
